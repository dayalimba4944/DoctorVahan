...
<content>
    ...
    <section class="sec-space testimonialsmain mt-75">
        <div class="container ">
            <div class="section-title text-center mb-3 mb-lg-5 wow fadeInUp" 
                >
                <h2>TESTIMONIALS</h2>
            </div>
            <div class="row ">
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="testymonial-box">
                        <div class="quote-main">
                            <img src=assets/image/quote.png" alt="Sara Jessi">
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.Vestibulum luctus convallis
                            iaculis.Pellentesque fauc ibusluctus enim eu luctus. Proin non laciniaaugue. Curabitur a
                            quam convallis iaculi</p>
                        <div class="auth-main">
                            <img src="assets/image/E1eba09909.jpg" alt="Sara Jessi" style="height: auto;">
                            <div class="auth-dtls">
                                <h3>Sara Jessi</h3>
                                <p>Customer</p>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="testymonial-box">
                        <div class="quote-main">
                            <img src=assets/image/quote.png" alt="Jhon Dio">
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.Vestibulum luctus convallis
                            iaculis.Pellentesque fauc ibusluctus enim eu luctus. Proin non laciniaaugue. Curabitur a
                            quam convallis iaculis</p>
                        <div class="auth-main">
                            <img src="assets/image/r8SXB09309.png" alt="Jhon Dio" style="height: auto;">
                            <div class="auth-dtls">
                                <h3>Jhon Dio</h3>
                                <p>Customer</p>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="testymonial-box">
                        <div class="quote-main">
                            <img src=assets/image/quote.png" alt="Jhon Smith">
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.Vestibulum luctus convallis
                            iaculis.Pellentesque fauc ibusluctus enim eu luctus. Proin non laciniaaugue. Curabitur a
                            quam convallis iaculis text test</p>
                        <div class="auth-main">
                            <img src="assets/image/GYO8f09709.png" alt="Jhon Smith" style="height: auto;">
                            <div class="auth-dtls">
                                <h3>Jhon Smith</h3>
                                <p>Customer</p>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="testymonial-box">
                        <div class="quote-main">
                            <img src=assets/image/quote.png" alt="Jack Sparrow">
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.Vestibulum luctus convallis
                            iaculis.Pellentesque fauc ibusluctus enim eu luctus. Proin non laciniaaugue. Curabitur a
                            quam convallis iaculis</p>
                        <div class="auth-main">
                            <img src="assets/image/hZA6F09709.png" alt="Jack Sparrow" style="height: auto;">
                            <div class="auth-dtls">
                                <h3>Jack Sparrow</h3>
                                <p>Customer</p>
                            </div>
            ...
            <div class="modal-content modal-style">
                <form id="msform" method="post" autocomplete="off" action="assets/image/booking-store">
                    ...
                    <fieldset>
                        <div class="modal-body">
                            ...
                            <div class="car-report mb-3 mb-md-4">
                                <img class="w-100" src=assets/image/scimg.png" alt="">
                            </div>
                    ...
                    <fieldset class="pb-0">
                        ...
                        <div class="modal-body p-0">
                            <div class="model-img">
                                <img src=assets/image/price-detsils-img.png" alt="img">
                            </div>
