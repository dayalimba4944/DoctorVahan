        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content modal-style">
                <form id="msform" method="post" autocomplete="off" action="assets/image/booking-store">
                    <input type="hidden" name="_token" value="JUX0NAEGorshoRGm3tBWiP4XYoroq49km5OwdOkA"
                        autocomplete="off">
                    <fieldset>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row row-gap mt-md-3" id="typesOfcarAreaPopup">
                                <div class="col-md-3 col-lg-3 col-6">
                                    <label class="radio-box">
                                        <strong>
                                            <img src="assets/image/storage/car_type/vDuAr06705.png"
                                                alt="">
                                            <h3>Bus</h3>
                                        </strong>
                                ...
                                <div class="col-md-3 col-lg-3 col-6">
                                    <label class="radio-box">
                                        <strong>
                                            <img src="assets/image/storage/car_type/r84P406605.png"
                                                alt="">
                                            <h3>Mini</h3>
                                        </strong>
                                ...
                                <div class="col-md-3 col-lg-3 col-6">
                                    <label class="radio-box">
                                        <strong>
                                            <img src="assets/image/storage/car_type/LNwoU06405.png"
                                                alt="">
                                            <h3>Taxi</h3>
                                        </strong>
                                ...
                                <div class="col-md-3 col-lg-3 col-6">
                                    <label class="radio-box">
                                        <strong>
                                            <img src="assets/image/storage/car_type/XQP0006705.png"
                                                alt="">
                                            <h3>Truck</h3>
                                        </strong>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row row-gap mt-3 mb-4">
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/6LC9b03201.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/RjHJx03701.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/xNJP403201.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/d7j5n03601.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/NRPkP07905.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/LA5qk07305.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/BMr9D07305.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/K7dcc07705.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/tWW9907705.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/NsiET07905.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/AodSH07305.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/jEuOp14505.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/0qpNE16306.png"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/bp25Q16706.jpg"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/GS8GP16906.jpg"
                                                alt=""></strong>
                                ...
                                <div class="col-3 col-lg-3">
                                    <label class="radio-box carlogo-box">
                                        <strong class="carlogo"> <img
                                                src="assets/image/storage/brand/KKe6w16306.webp"
                                                alt=""></strong>
                            ...
                            <div class="row row-gap mt-3">
                                <div class="col-md-6 col-6 col-lg-6">
                                    <label class="radio-box">
                                        <strong class="fuel-type">
                                            <img src="assets/image/storage/fuel_type/6qcp006507.png"
                                                alt="Diesel">
                                            Diesel
                                        </strong>
                                ...
                                <div class="col-md-6 col-6 col-lg-6">
                                    <label class="radio-box">
                                        <strong class="fuel-type">
                                            <img src="assets/image/storage/fuel_type/l5r2M06107.png"
                                                alt="Petrol">
                                            Petrol
                                        </strong>
