...
<content>
    ...
    <section class="sec-space bacwhite mt-5 ">
        <div class="container">
            <div class="row">
                <div class="col-md-6 wow fadeInUp"  
                    >
                    <div class="mb-md-4 mb-3">
                        <img src="assets/image/Mgn6K16410.png" class="vanPhoto" alt="DECARBONIZING CAR">
                    </div>
                    <div class="section-title">
                        <h2>DECARBONIZING CAR</h2>
                    ...
                    <div class="mt-md-4 mt-3">
                        <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"
                            class="btn button-solid">GET YOUR CAR ENGINE
                            REPORT</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="bookyourservice-form wow fadeInUp mt-md-0 mt-4" 
                        
                        >
                        <h3>Book Your Service</h3>
                        <h4>Your Details</h4>
                        <form method="post" autocomplete="off" id="serviceForm" novalidate="novalidate">
                            <input type="hidden" name="_token" value="bgnjBa6UUB0gI5hf3ZhhzqLD1722SKgrCZ5K0Vqy"
                                autocomplete="off"> <input type="hidden" name="enquiry_type" value="service">
                            <div class="form-row d-flex flex-row  gap-2 flex-wrap">
                                ...
                                <div class="form-group col-lg-6 col-md-7 captcha">
                                    <span> <img src="assets/image/captcha/default?KoxXMd89"></span>
                                ...
                                <div class="col-md-12 form-group text-center mt-lg-2 mb-0">
    ...
    <section class="sec-space contact-servicebg bg-gray">
        <div class="container">
            <div class="section-title text-center mb-4 pb-md-4">
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <h2>SERVICE FOR ALL</h2>
                        <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor
                            invidunt ut labore
                            ...
                            Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit a</p>
                    </div>
                </div>
            </div>

            <ul class="nav nav-pills mb-md-4 mb-3 pb-md-4 justify-content-center" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home"
                        aria-selected="true">CARS</button>
                    <!-- <a class="nav-link  active " id="pills-CARS-tab" data-toggle="pill" href="#pills-CARS" role="tab"
                        aria-controls="pills-CARS" aria-selected="true"></a> -->
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile"
                        aria-selected="false">VANS</button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact"
                        aria-selected="false">CLASSIC</button>
                </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                    tabindex="0">
                    <div class="row no-gutters servicebox-main">
                        <div class="px-0 col-md-6">
                            <div class="img-service">
                                <img src="assets/image/Mgn6K16410.png" class="vanPhoto2" alt="DECARBONIZING CAR">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="service-details p-lg-5 p-3">
                                <h2>DECARBONIZING CAR</h2>
                                <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod
                                    tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero
                                    eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea
                                    takimata sanctus est Lorem ipsum dolor</p>
                                <div class="mt-md-4 mt-3">
                                    <a href="assets/image/login" class="btn button-solid btn-dark">BOOK
                                        NOW</a>
                ...
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"
                    ...
                    <div class="row no-gutters servicebox-main">
                        <div class="px-0 col-md-6">
                            <div class="img-service">
                                <img src="assets/image/2NUx109612.webp" class="vanPhoto2" alt="VAN">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="service-details p-lg-5 p-3">
                                ...
                                <div class="mt-md-4 mt-3">
                                    <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"
                                        class="btn button-solid btn-dark">BOOK
                                        NOW</a>
                ...
                <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"
                    tabindex="0">
                    <div class="row no-gutters servicebox-main">
                        <div class="px-0 col-md-6 bg-white">
                            <div class="img-service">
                                <img src="assets/image/ZR3Jl09712.webp" class="vanPhoto2" alt="COMMERCIAL">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="service-details p-lg-5 p-3">
                ...
                <div class="tab-pane fade" id="pills-dis" role="tabpanel" aria-labelledby="pills-dis-tab" tabindex="0">
                    <div class="row no-gutters servicebox-main">
                        <div class="px-0 col-md-6">
                            <div class="img-service">
                                <img src="assets/image/CXiBV09112.jpg" class="vanPhoto2" alt="CLASSIC">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="service-details p-lg-5 p-3">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content modal-style">
                    <form id="msform" method="post" autocomplete="off">
                        ...
                        <fieldset style="display: block; position: relative; opacity: 1;">
                            <div class="modal-header">
                                <h2 class="modal-title" id="exampleModalLabel"> PLEASE PROVIDE YOUR CAR DETAILS TO GET
                                    AN
                                    ENGINE
                                    REPORT
                                </h2>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row row-gap mt-md-3" id="typesOfcarAreaPopup">
                                    <div class="col-md-3 col-lg-3 col-6">
                                        <label class="radio-box">
                                            <strong>
                                                <img src="assets/image/vDuAr06705.webp" alt="">
                                                <h3>Bus</h3>
                                            </strong>
                                    ...
                                    <div class="col-md-3 col-lg-3 col-6">
                                        <label class="radio-box">
                                            <strong>
                                                <img src="assets/image/r84P406605.webp" alt="">
                                                <h3>Mini</h3>
                                            </strong>
                                    ...
                                    <div class="col-md-3 col-lg-3 col-6">
                                        <label class="radio-box">
                                            <strong>
                                                <img src="assets/image/LNwoU06405.webp" alt="">
                                                <h3>Taxi</h3>
                                            </strong>
                                    ...
                                    <div class="col-md-3 col-lg-3 col-6">
                                        <label class="radio-box">
                                            <strong>
                                                <img src="assets/image/XQP0006705.webp" alt="">
                                                <h3>Truck</h3>
                                            </strong>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row row-gap mt-3 mb-4">
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/6LC9b03201.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/RjHJx03701.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/xNJP403201.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/d7j5n03601.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/NRPkP07905.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/LA5qk07305.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/BMr9D07305.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/K7dcc07705.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/tWW9907705.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/NsiET07905.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/AodSH07305.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/jEuOp14505.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/0qpNE16306.webp"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/bp25Q16706.jpg"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/GS8GP16906.jpg"
                                                    alt=""></strong>
                                    ...
                                    <div class="col-3 col-lg-3">
                                        <label class="radio-box carlogo-box">
                                            <strong class="carlogo"> <img src="assets/image/KKe6w16306.webp"
                                                    alt=""></strong>
                                ...
                                <div class="row row-gap mt-3">
                                    <div class="col-md-6 col-6 col-lg-6">
                                        <label class="radio-box">
                                            <strong class="fuel-type">
                                                <img src="assets/image/6qcp006507.webp" alt="Diesel">
                                                Diesel
                                            </strong>
                                    ...
                                    <div class="col-md-6 col-6 col-lg-6">
                                        <label class="radio-box">
                                            <strong class="fuel-type">
                                                <img src="assets/image/l5r2M06107.webp" alt="Petrol">
                                                Petrol
                                            </strong>
                        ...
                        <fieldset style="display: none; position: relative; opacity: 0;">
                            <div class="modal-body">
                                ...
                                <div class="car-report mb-3 mb-md-4">
                                    <img class="w-100" src="assets/image/scimg.webp" alt="">
                                </div>
                                    ...
                                    <div class="row row-gap">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="report-box">
                                                ...
                                                <div class="mdetails">
                                                    <strong class="your_score_area"></strong> <span>Your
                                                        <br>Score</span>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <fieldset class="pb-0" style="display: none; position: relative; opacity: 0;">
                            ...
                            <div class="modal-body p-0">
                                <div class="model-img">
                                    <img src="assets/image/price-detsils-img.webp" alt="img">
                                </div>
                                                    ...
                                                    <div class="list">
                                                        <ul>
                                                            ...
                                                            <li class="option " data-value="1"
                                                                data-display-text="Kolkata">
                                                                Kolkata</li>
                                                            <li class="option " data-value="2"
                                                                data-display-text="Howrah">
                                                                Howrah
                                                            </li>
                                                        </ul>
                                                    </div>
